...
class House {
  ...
  constructor(components) {
    ...
    if(components.hasOwnProperty('num_baths')){
      this.num_bahts = components['num_baths']
    }
    this.cost = 320000
...
const cool = new House({address: 'jalankesonokesinitruskesonolagi',square_feet: 100, num_bedrooms: 2,num_baths: 2,cost: 12345,down_payment: 12345,sold: true,short_sale: true})
